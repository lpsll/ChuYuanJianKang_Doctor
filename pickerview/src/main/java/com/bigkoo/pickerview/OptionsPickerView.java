...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    public void setWheelOptionsItem1SelectedListener(OnItemSelectedListener listener){
        wheelOptions.getWv_option1().setOnItemSelectedListener(listener);
    }
    public void setWheelOptionsItem2SelectedListener(OnItemSelectedListener listener){
        wheelOptions.getWv_option2().setOnItemSelectedListener(listener);
    }
