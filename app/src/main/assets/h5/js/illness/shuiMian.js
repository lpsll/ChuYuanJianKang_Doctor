...
function saveData() {
	...
	var Fvalue2 = Freq2.value;
	if (Fvalue.length == 0) {
		Freq.setAttribute('placeholder', '请选择睡觉时间');
		return false;
	} else if(Fvalue2.length == 0){
		Freq2.setAttribute('placeholder','请选择起床时间');
...
function checkHistory() {
	window.location.href = "History.html?id=9";
}